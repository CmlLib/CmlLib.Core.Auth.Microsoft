...
namespace CmlLib.Core.Auth.Microsoft.Mojang
{
    public class MinecraftAuthException : Exception
    {
        ...
        public MinecraftAuthException(string? error, string? errorType, string? errorMessage, int statusCode) : base(CreateMessageFromError(error, errorType, errorMessage)) =>
        ...
        public static MinecraftAuthException FromResponseBody(string responseBody, int statusCode)
        {
            try
            {
                ...
                return new MinecraftAuthException(error, errorType, errorMessage, statusCode);
            }
            catch (JsonException)
            {
                throw new FormatException();
