...
namespace CmlLib.Core.Auth.Microsoft.UI.WinForm
{
    internal class WinFormsPanelWithWebView2 : Form
    {
        ...
        private IWebUILoginHandler? _loginHandler;
        ...
        public MicrosoftOAuthCode DisplayDialogAndInterceptUri(IWebUILoginHandler loginHandler, CancellationToken cancellationToken)
        {
            ...
            _webView2.Source = new Uri(_loginHandler.CreateOAuthUrl());
        ...
        private bool CheckForEndUrl(Uri url)
        {
            ...
            var result = _loginHandler.CheckOAuthCodeResult(url);
            readyToClose = result.IsSuccess;
